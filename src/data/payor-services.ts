...
export const payorServices: PayorService[] = [
  ...
  },
  {
    ...
    description:
      "Michael Hill MD and Associates — ED Facility Level Methodology Review: Evaluate internal policies and clinical documentation to align hospital billing with national standards, ensuring that every facility level assignment is proportionate to the patient\u2019s clinical presentation.",
    heroDescription:
