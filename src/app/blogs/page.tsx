...
export default async function BlogsPage() {
  let dynamicPosts: { id: string; title: string; slug: string; excerpt: string | null; published_at: string | null; html_url: string | null; tags: string[] | null; cover_image_url: string | null; cover_image_position: number | null }[] = [];
  try {
    const supabase = await createClient();
    const { data } = await supabase
      .from('blog_posts')
      .select('id, title, slug, excerpt, published_at, html_url, tags, cover_image_url, cover_image_position')
